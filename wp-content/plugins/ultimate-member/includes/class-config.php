	...
	class Config {
		...
		function __construct() {
			...
			$this->settings_defaults = array(
				...
				'delete_account_text'                   => __('Tem certeza que deseja deletar sua conta? Isso irá deletar todos seus dados do site. Para deletar sua conta informe sua senha abaixo','ultimate-member'),
				'account_name'                          => 1,
